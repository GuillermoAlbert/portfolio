        ...
        <div className="xp reveal" data-d="1" data-stagger>
          ...
          <article className="xp__item">
            ...
            <T
              ...
              as="p"
              className="xp__desc"
              es="Investigación en el CSIC (Estación Biológica de Doñana) y en el Museo de Historia Natural de Helsinki, con un Máster en Biodiversidad (Univ. de València). Secuenciación de datos, medición de biodiversidad y 3 publicaciones revisadas por pares — el origen de mi enfoque basado en la evidencia."
              en="Research at CSIC (Doñana Biological Station) and the Helsinki Natural History Museum, with an MSc in Biodiversity (Univ. of Valencia). Sequencing data, measuring biodiversity, and 3 peer-reviewed publications — the origin of my evidence-based approach to engineering."
              fr="Recherche au CSIC (Station biologique de Doñana) et au Muséum d'histoire naturelle d'Helsinki, avec un Master en Biodiversité (Univ. de Valence). Séquencer des données, mesurer la biodiversité et 3 publications évaluées par les pairs — l'origine de mon approche fondée sur les preuves."
            />
          </article>
        </div>
      </div>
